...
fetch(`https://api.affiliateplus.xyz/api/chatbot?message=${encodeURIComponent(message.content)}&botname=${client.user.username}&ownername=Swayz#6126`)
    .then(res => res.json())
    .then(data => {
...
client.on
client.on("ready", () => {
    client.user.setActivity(`z!help | in ${client.guilds.cache.size} servers`, { type: "WATCHING"})
})
